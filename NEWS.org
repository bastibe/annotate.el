- 2023-10-10 v2.1.0 cage ::
  ...
  This version ensures that the color scheme for each annotation (both
  underline color of the annotated text and colors of the annotation),
  is kept when reopening an annotated file.
